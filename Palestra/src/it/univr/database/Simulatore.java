...
//				pstm2.setDate(3, new java.sql.Date(listaUtenti.get(i).getDn().getTime()));
				...
				pstm2.execute();
				System.out.println("Iscrizione al corso con id: "+id_corso+" avvenuta per utente ["+(i+1)+"] : "+listaUtenti.get(i).getNome()+" "+listaUtenti.get(i).getCognome());
